...
<!-- Registration Start -->
<div class="container-fluid bg-registration py-5 mb-4">
        ...
        <div class="row align-items-center">
            <div class="col-lg-7 mb-5 mb-lg-0">
                ...
                <ul class="list-inline text-white m-0">
                    ...
                    <li class="py-2"><i class="fa fa-check text-primary mr-3"></i>Trouver de nouveaux clients.
                    </li>
                ...
                <div class="card" style="background-color: rgba(0,0,0,.7)">
                    ...
                    <div>
                        <a class="btn btn-primary btn-block py-3"
                            href="{{ route('register') }}#prefournisseur">Inscrivez-vous</a>
                    </div>
                </div>
            </div>
        </div>
