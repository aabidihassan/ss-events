        ...
        <div class="col-xl-8 col-lg-7">            
            ...
            <div class="card shadow mb-4">
                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                    <h6 class="m-0 font-weight-bold text-primary" id="titel_charts_bar">Bar Chart</h6>
                ...
                <div class="card-body">
                    <div class="chart-bar">
                        <script>
                            var _data_myAreaChartBar = [20,100,50,10,5,60];
                            var _data_libelle_cities = ["Casa","Rabat","Salé","Agadir","Safi","marrakech"];
                        </script>
