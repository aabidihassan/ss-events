            ...
            <nav class="navbar navbar-expand-lg bg-light navbar-light shadow-lg py-3 py-lg-0 pl-3 pl-lg-5">
                ...
                <div class="collapse navbar-collapse justify-content-between px-3" id="navbarCollapse">
                    <div class="navbar-nav ml-auto py-0 menu">
                        <a href="/admin/pres" class="nav-item nav-link">Pre Fournisseurs</a>
                        <a href="/admin/fournisseurs" class="nav-item nav-link">Fournisseurs</a>
                        <a href="/admin/clients" class="nav-item nav-link">Clients</a>
                        <a href="/admin/services" class="nav-item nav-link">Services</a>
                        <a href="/admin/feedbacks" class="nav-item nav-link">Feedbacks</a>
                    </div>
                </div>
            </nav>
        </div>
